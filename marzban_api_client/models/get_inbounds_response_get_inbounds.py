...
T = TypeVar("T", bound="GetInboundsResponseGetInbounds")


@_attrs_define
class GetInboundsResponseGetInbounds:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        get_inbounds_response_get_inbounds = cls()
        ...
        get_inbounds_response_get_inbounds.additional_properties = additional_properties
        return get_inbounds_response_get_inbounds
